...
import com.example.dalu.a370project.receiver.MyAppWidgetProvider;
...
/*        remoteViews.setTextColor(R.id.tv_process_count, Color.BLUE);
        remoteViews.setTextColor(R.id.tv_process_memory, Color.GREEN);*/
